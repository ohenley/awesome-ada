...
<!--lint disable awesome-spell-check-->
- [scala](https://www.huygens-fokker.org/scala) - A powerful software tool for experimentation with musical tunings, such as just intonation scales, equal and historical temperaments, microtonal and macrotonal scales, and non-Western scales.<!--lint enable awesome-list-item-->
